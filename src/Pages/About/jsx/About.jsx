...
export const About= () => (
  ...
  <div className="about-wrap">
    ...
    <p className="paragraph"><i>ВСЕ ДЛЯ ДОМА</i> — первый в Минске <i>строительный гипермаркет</i> формата DIY, соответствующий высоким стандартам обслуживания европейского уровня.</p>
