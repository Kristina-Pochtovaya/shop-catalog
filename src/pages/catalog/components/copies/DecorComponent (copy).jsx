      ...
      <div className="container-wrap">
        <div className="items">
          <div className="item-wrap">
            ...
            <img className="imgItem" src={decor1} alt="Часы настенные Troyka 91900929 (230)" title="Часы настенные Troyka 91900929 (230)" />
            <h4>Часы настенные Troyka 91900929 (230)</h4>
          ...
          <div className="item-wrap">
            ...
            <img className="imgItem" src={decor2} alt="Репродукция в раме Styler Осень-1 (OB-02591) 500x500" title="Репродукция в раме Styler Осень-1 (OB-02591) 500x500" />
            <h4>Репродукция в раме Styler Осень-1 (OB-02591) 500x500</h4>
            <div className="purchase">
              <p>42 РУБ.</p>
              <button
                className="busketButton"
          ...
          <div className="item-wrap">
            ...
            <img className="imgItem" src={decor3} alt="Подушка декоративная Nivasan Дино (DP.D-1) 40x40 см" title="Подушка декоративная Nivasan Дино (DP.D-1) 40x40 см" />
            <h4>Подушка декоративная Nivasan Дино (DP.D-1) 40x40 см</h4>
            <div className="purchase">
              <p>28 РУБ.</p>
              <button
                className="busketButton"
