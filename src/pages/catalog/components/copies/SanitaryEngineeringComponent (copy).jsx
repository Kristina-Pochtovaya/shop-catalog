      ...
      <div className="container-wrap">
        <div className="items">
          <div className="item-wrap">
            ...
            <img className="imgItem" src={sanitaryEngineering1} alt="Душевой уголок Triton Риф 90*90 А" title="Душевой уголок Triton Риф 90*90 А" />
            <h4>Душевой уголок Triton Риф 90*90 А</h4>
          ...
          <div className="item-wrap">
            ...
            <img className="imgItem" src={sanitaryEngineering2} alt="Зеркало подвесное Mixline Блюз" title="Зеркало подвесное Mixline Блюз" />
            <h4>Зеркало подвесное Mixline Блюз</h4>
            <div className="purchase">
              <p>104 РУБ.</p>
              <button
          ...
          <div className="item-wrap">
            ...
            <img className="imgItem" src={sanitaryEngineering3} alt="Ванна Троя ЭКСТРА (1670 x 960 x 580, 250 л)" title="Ванна Троя ЭКСТРА (1670 x 960 x 580, 250 л)" />
            <h4>Ванна Троя ЭКСТРА (1670 x 960 x 580, 250 л)</h4>
            <div className="purchase">
              <p>598 РУБ.</p>
              <button
                className="busketButton"
