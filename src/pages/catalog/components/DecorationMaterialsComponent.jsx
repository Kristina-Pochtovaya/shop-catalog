      ...
      <div className="container-wrap">
        <div className="items">
          <div className="item-wrap">
            ...
            <img className="imgItem" src={decorationMaterials1} alt="Ковер" title="Ковер" />
            <h4>Ковер</h4>
          ...
          <div className="item-wrap">
            ...
            <img className="imgItem" src={decorationMaterials2} alt="Плитка керамическая" title="Плитка керамическая" />
